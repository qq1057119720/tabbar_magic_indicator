...
class MagicTab extends StatelessWidget {
...
class _IndicatorPainter extends CustomPainter {
  ...
  final MagicTabBarIndicatorSize indicatorSize;
  ...
  Rect indicatorRect(Size tabBarSize, int tabIndex) {
    ...
    if (indicatorSize == MagicTabBarIndicatorSize.label) {
...
class MagicTabBar extends StatefulWidget implements PreferredSizeWidget {
...
class _TabBarState extends State<MagicTabBar> {
  ...
  @override
  void didUpdateWidget(MagicTabBar oldWidget) {
...
///
/// To see a sample implementation, visit the [TabController] documentation.
class MagicTabBarView extends StatefulWidget {
  /// Creates a page view with one child per tab.
  ///
  /// The length of [children] must be the same as the [controller]'s length.
  const MagicTabBarView({
    Key key,
...
class _TabBarViewState extends State<MagicTabBarView> {
  TabController _controller;
  ...
  @override
  void didUpdateWidget(MagicTabBarView oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (widget.controller != oldWidget.controller)
      _updateTabController();
